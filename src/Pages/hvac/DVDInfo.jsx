...
import { useDeleteDvdInfoMutation, useGetDvdInfoQuery } from "../redux/api/routesApi";
...
const DVDInfo = () => {
    const { data, isLoading, isError } = useGetDvdInfoQuery();
  const [deleteInsurance] = useDeleteDvdInfoMutation();
