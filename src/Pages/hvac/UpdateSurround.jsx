...
const UpdateSurround = () => {
      const {id} = useParams();
    const {data:singleUpdate} = useGetSingleSurroundSoundQuery({id})
  ...
  const parseNumber = (value) => {
    ...
    return value.replace(/,/g, "");
     ...
     useEffect(() => {
      if (singleUpdate?.surroundSound
) {
        const admin = singleUpdate?.surroundSound
    ...
    <div className="container m-auto">
      <div className=" lg:mt-11 mt-6 px-3">
        <div className=" pb-7 lg:pb-0">
          ...
          Update Surround Sound Information
          </h1>
        </div>
