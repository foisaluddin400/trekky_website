...
const UpdateDishwasher = () => {
    const {id} = useParams();
    const {data:singleUpdate} = useGetSingleDisherInfoQuery({id})
  ...
  //   };
   ...
   useEffect(() => {
      if (singleUpdate?.dishwasher
) {
        const admin = singleUpdate?.dishwasher
...
export default UpdateDishwasher;
