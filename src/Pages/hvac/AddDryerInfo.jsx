...
import { useAddDriyerMutation, useAddWasherMutation, useAddWaterPumpMutation } from "../redux/api/routesApi";
...
const AddDryerInfo = () => {
  ...
  const [addHeater] = useAddDriyerMutation();
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      navigate("/details/AddExhaustFansInfo");
      form.resetFields();
      setFileList([]);
    } catch (err) {
