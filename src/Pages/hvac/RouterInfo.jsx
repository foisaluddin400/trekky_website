...
import { useDeleteRouterMutation, useGetRouterQuery } from "../redux/api/routesApi";
...
const RouterInfo = () => {
      const { data, isLoading, isError } = useGetRouterQuery();
  const [deleteInsurance] = useDeleteRouterMutation();
          ...
          >
           <div className="text-gray-800 space-y-2 font-semibold">
            ...
            <div className="flex justify-end gap-2 mt-3">
              ...
              <Link to={`/details/Router/update-router/${item._id}`}>
