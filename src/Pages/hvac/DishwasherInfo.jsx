...
const DishwasherInfo = () => {
  ...
  const [deleteInsurance] = useDeleteDisherInfoMutation();
        ...
        {data?.dishwashers?.map((item) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 mt-3">
              ...
              <Link to={`/details/Dishwasher/update-dishwasher/${item._id}`}>
