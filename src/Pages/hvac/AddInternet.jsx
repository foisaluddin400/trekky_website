...
import { useAddInternetSatettlingMutation, useAddWasherMutation, useAddWaterPumpMutation } from "../redux/api/routesApi";
...
const AddInternet = () => {
  ...
  const [addHeater] = useAddInternetSatettlingMutation();
      ...
      <div className=" lg:mt-11 mt-6 px-3">
        <div className=" pb-7 lg:pb-0">
          <h1 className="text-3xl font-semibold text-[#F9B038]">
            Add Internet/Satellite Information
          </h1>
        </div>
