...
import { useDeleteCallingFansMutation, useGetCallingFansQuery } from "../redux/api/routesApi";
...
const CellingInfo = () => {
    const { data, isLoading, isError } = useGetCallingFansQuery();
  const [deleteInsurance] = useDeleteCallingFansMutation();
  ...
  return (
    <div className="container m-auto py-8 px-3 lg:px-0">
      <div className="flex justify-between">
        ...
        <Link to={"/details/AddCellingFans"}>
        ...
        {data?.cellingFans?.map((item) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 mt-3">
              ...
              <Link to={`/details/Celling/updateCalling-fans/${item._id}`}>
