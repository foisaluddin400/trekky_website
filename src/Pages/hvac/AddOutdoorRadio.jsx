...
import { useAddOutdoorMutation, useAddWasherMutation, useAddWaterPumpMutation } from "../redux/api/routesApi";
...
const AddOutdoorRadio = () => {
  const navigate = useNavigate();
  const [addHeater] = useAddOutdoorMutation();
...
export default AddOutdoorRadio;
