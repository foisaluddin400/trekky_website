...
import { useDeleteSurroundSoundMutation, useGetSurroundSoundQuery } from "../redux/api/routesApi";
...
const SurroundInfo = () => {
    const { data, isLoading, isError } = useGetSurroundSoundQuery();
  const [deleteInsurance] = useDeleteSurroundSoundMutation();
        ...
        {data?.surroundSound?.map((item) => (
          ...
          >
            ...
            <div className="flex justify-end gap-2 mt-3">
              ...
              <Link to={`/details/Surround/update-surround/${item._id}`}>
