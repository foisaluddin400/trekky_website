...
import { useAddGpsMutation, useAddWasherMutation, useAddWaterPumpMutation, useGetSingleGpsQuery, useUpdateGpsMutation } from "../redux/api/routesApi";
...
const UpdateGps = () => {
        const {id} = useParams();
    const {data:singleUpdate} = useGetSingleGpsQuery({id})
    console.log(singleUpdate)
  const navigate = useNavigate();
  const [addHeater] = useUpdateGpsMutation();
