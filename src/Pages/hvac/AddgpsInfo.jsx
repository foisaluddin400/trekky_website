...
import { useAddGpsMutation, useAddWasherMutation, useAddWaterPumpMutation } from "../redux/api/routesApi";
...
const AddgpsInfo = () => {
  ...
  const [addHeater] = useAddGpsMutation();
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      navigate("/details/AddOutdoorRadio");
      form.resetFields();
      setFileList([]);
    } catch (err) {
