...
import { useDeleteGpsMutation, useGetGpsQuery } from "../redux/api/routesApi";
...
const GPSInfo = () => {
    const { data, isLoading, isError } = useGetGpsQuery();
  const [deleteInsurance] = useDeleteGpsMutation();
