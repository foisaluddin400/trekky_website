  ...
  return (
    <div className="max-w-4xl m-auto">
      <Form form={form} onFinish={handleSubmit} layout="vertical">
        <Form.Item
           label={<span style={{ color: "#F9B038" }}>Select State</span>}
          name="state"
        ...
        <Form.Item
           label={<span style={{ color: "#F9B038" }}>Select Type</span>}
          name="type"
        ...
        <Form.Item
           label={<span style={{ color: "#F9B038" }}>Camped in traveled through planned</span>}
          name="feedback"
